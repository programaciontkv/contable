...
<section class="content-header">
	<form id="exp_excel" style="float:right;padding:0px;margin: 0px;" method="post" action="<?php echo base_url();?>liquidacion/excel/<?php echo $permisos->opc_id?>" onsubmit="return exportar_excel()"  >
		...
		<div class="box box-body">
			...
			<div class="row">
				<div class="col-md-2">
					...
					?>
						<a href="<?php echo base_url();?>liquidacion/nuevo/<?php echo $permisos->opc_id?>" class="btn btn-success btn-flat"><span class="fa fa-plus"></span> Crear asiento </a>
					<?php 
					}
					?>
				</div>	
					...
					<table id="tbl_list" class="table table-bordered table-list table-hover" style="margin-left:-22px">
						...
						?>
							<tr>
								...
								<td><?php echo $asiento->cli_raz_social?></td>
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											<a href="<?php echo base_url();?>liquidacion/editar/<?php echo $asiento->con_asiento?>/<?php echo $permisos->opc_id?>" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Asiento de Liquidacion</h4>
              </div>
...
<script type="text/javascript">
	function cambiar_es(estado,id){
		...
		Swal.fire({
		  title: 'Desea cambiar de estado del asiento?',
		  ...
		  if (result.isConfirmed) {
		    ...
		    var  uri=base_url+"liquidacion/cambiar_estado/"+estado+"/"+id+"/"+op;
				      $.ajax({
				              url: uri,
				              type: 'POST',
				              success: function(dt){
	...
	function envio(id,opc){
		if(opc==0){
			...
			url="<?php echo base_url();?>liquidacion/show_frame/"+id+"/<?php echo $permisos->opc_id?>";
		}
