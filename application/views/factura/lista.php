		...
		<div class="box box-body">
			...
			<div class="row">
				<div class="col-md-2">
					...
					?>
						<a href="<?php echo $direccion?>" class="btn btn-success btn-flat"><span class="fa fa-plus"></span> Crear Factura </a>
					<?php 
					}
					?>
				</div>
				...
				<div class="col-md-12">
					<table id="tbl_list" style="margin-left:-10px" class="table table-bordered table-list table-hover">
						<thead>
							...
							<th>Ajustes</th>
							<th class="hidden-mobile">Todos <input type='checkbox' id='chk_todos' onclick="seleccionar()" /></th>
						</thead>
						<tbody>
						<?php 
				        $dec=$dec->con_valor;
	...
	var ruta=base_url+"factura/consulta_sri/"+id+"/"+opc+"/0";
        $.ajax({
            ...
            error: function (j, t, e) {
                        if (t == 'timeout') {
                            Swal.fire('Tiempo agotado No se pudo enviar correo');
                        }else{
                        	Swal.fire(e);
                        }
            }
