...
function validar(table, opc) {
    ...
    if (opc == 0) {
        ...
        if ($('#cantidad').val().length != 0 && parseFloat($('#cantidad').val()) > 0 && $('#descuento').val().length !=
            0 && $('#pro_descripcion').val().length != 0) {
...
function clona_detalle(table, opc) {
    ...
    if (d == 0) {
        ...
        var fila = "<tr>" +
            ...
            .value + "' onkeyup='validar_decimal(this),validar_cantidad(1,this)'/>" +
            "</td>" +
            "<td>" +
