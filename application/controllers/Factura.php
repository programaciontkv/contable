...
public function buscar_cliente_2($txt){
	...
	public function load_producto($inven,$ctr_inv,$fpag,$emi,$lang){
...
$xml.="<factura version='1.1.0' id='comprobante'>" . chr(13);
    ...
    $xml.="<detalles>" . chr(13);
        ...
        $xml.="<detalle>" . chr(13);
            $xml.="<codigoPrincipal>" . trim(substr($det->mp_c,0,25)) . "</codigoPrincipal>" . chr(13);
            if (trim($det->mp_n) != '') {
            ...
            $xml.="<precioTotalSinImpuesto>" . round($det->dfc_precio_total, $round) . "</precioTotalSinImpuesto>" .
            chr(13);
...
// header("Location:
http://localhost:8080/central_xml_local/envio_sri/firmar.php?clave=$clave&programa=$programa&firma=$firma&password=$pass&ambiente=$ambiente");
}
}
...
<body>
    <table width='100%'>
        ...
        <tr>
            <td><img height='150px' width='300px' src='$img_logo' /></td>
        </tr>
        <tr>
            <td></br></br> </td>
        </tr>
        ...
        <tr>
            <td>Emisor: $datos->emisor </td>
        </tr>
        <tr>
            <td>Tipo de Documento: $datos->tipo </td>
        </tr>
        <tr>
            <td>Numero de Documento: $datos->numero </td>
        </tr>
        <tr>
            <td>Total $: ". number_format($datos->total,2)."</td>
        </tr>
        <tr>
            <td></br></br> </td>
        </tr>
        ...
        <tr>
            <td>Adjuntamos el comprobante en formato PDF y XML </td>
        </tr>
        <tr>
            <td>Para consultar documentos electronicos :</td>
        </tr>
        <tr>
            <td>Usuario : Su numero de identificacion</td>
        </tr>
        <tr>
            <td>Clave :$datos->clave_usu</td>
        </tr>
        <tr>
            <td></br></br> </td>
        </tr>
        ...
        <tr>
            <td style='font-size:10px'>Copyright &copy; 2022 Todos los derechos reservados <a href=''>TIKVASYST
                    S.A.S</a></td>
        </tr>
    </table>
</body>
...
$j = 0;
while ($j <= count($array)) { if (!empty($array[$j])) { $this->asiento_model->insert($array[$j]);
    }
    $j++;
    }
