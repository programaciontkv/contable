		...
		if($this->form_validation->run()){
		    ...
		    while($n<$count_det){
			    ...
			    if($this->input->post("con_documento$n")!=''){
			    	...
			    	$con_concepto_debe = $this->input->post("con_id_debe$n");
			    	$con_concepto_haber = $this->input->post("con_id_haber$n");
		...
		if($this->permisos->rop_actualizar){
			...
			foreach ($detalle as $det) {
				...
				$dt= (object) array(
							...
							'con_id_debe'=>$det->con_concepto_debe,
							'con_id_haber'=>$det->con_concepto_haber,
							'con_concepto_debe'=>$cod_db,
							'con_concepto_haber'=>$cod_hb,
